...
class Administrators extends CI_Controller{
    ...
    */
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('firstName', 'First name', ['required', 'trim', 'max_length[30]', 'strtolower', 'ucfirst'], ['required'=>"required"]);
        $this->form_validation->set_rules('lastName', 'Last name', ['required', 'trim', 'max_length[30]', 'strtolower', 'ucfirst'], ['required'=>"required"]);
        ...
        $this->form_validation->set_rules('mobile1', 'Phone number', ['required', 'trim', 'numeric', 'max_length[30]', 'is_unique[admin.mobile1]'], 
                ['required'=>"required", 'is_unique'=>"This number is already attached to an admin"]);
        $this->form_validation->set_rules('mobile2', 'Other number', ['trim', 'numeric', 'max_length[30]']);
    ...
    */
    ...
    public function update(){
        ...
        $this->form_validation->set_rules('firstName', 'First name', ['required', 'trim', 'max_length[50]'], ['required'=>"required"]);
        $this->form_validation->set_rules('lastName', 'Last name', ['required', 'trim', 'max_length[50]'], ['required'=>"required"]);
        $this->form_validation->set_rules('mobile1', 'Phone number', ['required', 'trim', 'numeric', 'callback_crosscheckMobile['. $this->input->post('adminId', TRUE).']'], ['required'=>"required"]);
        ...
        if($this->form_validation->run() !== FALSE){
            ...
            $updated = $this->admin->updateWithPassword($admin_id, set_value('firstName'), set_value('lastName'), set_value('email'),
                set_value('mobile1'), set_value('mobile2'), set_value('role'), $password);
