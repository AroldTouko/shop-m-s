            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2 form-inline form-group-sm">
                        <button class="btn btn-primary btn-sm" id='createItem'>Ajouter produit</button>
                    </div>
                    ...
                    <div class="col-sm-4 form-group-sm form-inline">
                        ...
                        <select id="itemsListSortBy" class="form-control">
                            ...
                            <option value="unitPrice-DESC">Prix Unit. (Desc)</option>
                            <option value="quantity-DESC">Quantité (Desc)</option>
                            <option value="name-DESC">Nom (Z-A)</option>
                            <option value="code-DESC">Code (Desc)</option>
                            <option value="unitPrice-ASC">Prix Unit. (ASC)</option>
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        ...
                        <input type="search" id="itemSearch" class="form-control" placeholder="Chercher produits">
                    </div>
                </div>
            </div>
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                <label for="itemCode">Code produit</label>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                <label for="itemDescription" class="">Description (Optionnel)</label>
                        ...
                        <div class="row text-center">
                            <div class="col-sm-6 form-group-sm">
                                <button class="btn btn-primary btn-sm" id="addNewItem">Ajouter produit</button>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group-sm">
                            ...
                            <select id="stockUpdateType" class="form-control checkField">
                                ...
                                <option value="deficit">Sortie de stock</option>
                            </select>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form">
                    <div class="row">
                        <div class="col-sm-4 form-group-sm">
                            <label for="itemNameEdit">Nom produit</label>
                    ...
                    <div class="row">
                        <div class="col-sm-12 form-group-sm">
                            <label for="itemDescriptionEdit" class="">Description (Optionnel)</label>
