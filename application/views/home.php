                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <div style="font-size:100px">
                                <h1><img src="<?=base_url()?>public/images/logo_white.png" alt="sales-logo" height="150px"></h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-bottom">
                                <form id="loginForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" placeholder="Votre mot de passe" class="form-control checkField" id="password" >
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center" style="color:white">
                            Réalisé par  <a href="" target='_blank' class="text-primary">DDANK-ENTERPRISE</a>
                        </div>
                    </div>
                </div>
            </div>
