    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="nav navbar-nav navbar-left visible-xs">
                        ...
                        <!--
                        <li class="<?= $pageTitle == 'Supliers' ? 'active' : '' ?>">
                            <a href="<?= site_url('supliers') ?>">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a>
                                Total Ventes Aujourd'hui: <b>FCFA <span id="totalEarnedToday"></span></b>
                            </a>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>--->
                                <li><a href="<?= site_url('logout') ?>"><i class="fa fa-sign-out"></i> Déconnexion</a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
        ...
        <footer class="container-fluid text-center hidden-print">
            <p>
                ...
                Copyright <a href="#"> WANDJI CHICHA</a> (2021) Developpé par <a href="https://www.ddank-enterprise.com"> DDANK-ENTERPRISE</a>
            </p>
        </footer>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header hidden-print">
                        ...
                        <h4 class="text-center">Reçu de Vente</h4>
                    </div>
                        ...
                        <form name="logInModalForm">
                            <div class="row">
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <input type="password" id='logInModalPassword' class="form-control checkField" placeholder="Mot de passe">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 pull-right">
                                    <button id='loginModalSubmit' class="btn btn-primary">Connexion</button>
                                </div>
                            </div>
                        </form>
                    </div>
