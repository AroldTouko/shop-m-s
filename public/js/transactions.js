...
$(document).ready(function(){
    ...
    /**
     * If mode of payment is "MTN", both #cashAmount and #posAmount fields will be visible to user to add values
    ...
    $("#showTransForm").click(function(){
        ...
        if($("#newTransDiv").hasClass('collapse')){
            $(this).html("<i class='fa fa-plus'></i> Nouvelle vente");
        }
        
        else{
            $(this).html("<i class='fa fa-minus'></i> Nouvelle vente");
    ...
    $("#hideTransForm").click(function(){
        ...
        $("#showTransForm").html("<i class='fa fa-plus'></i> Nouvelle vente");
    });
